...
const Portfolio = () => {
  const projects = [
    {
      id: 1,
      image: './public/images/Pear-Music.png',
      name: 'Pear Music',
    ...
    {
      id: 2,
      image: './public/images/Shape-Shift.png',
      name: 'Shape Shift',
    ...
    {
      id: 3,
      image: './public/images/Note-Taker.png',
      name: 'Note Taker',
    ...
    {
      id: 4,
      image: './public/images/Coding-quiz.png',
      name: 'Coding Quiz',
    ...
    {
      id: 5,
      image: './public/images/Planner-App.png',
      name: 'Planner App',
